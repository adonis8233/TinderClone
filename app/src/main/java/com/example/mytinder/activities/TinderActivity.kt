...
import com.example.mytinder.fragments.MatchesFragment
import com.example.mytinder.fragments.ProfileFragment
import com.example.mytinder.fragments.SwipeFragment
import com.example.mytinder.util.DATA_CHATS
...
class TinderActivity : AppCompatActivity(), TinderCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // !! means it's sure that the variable is not null;
