...
class ProfileFragment : Fragment() {
    ...
    // this variable will be instantiated before we use it.
    ...
    fun onApply() {
        if (nameET.text.toString().isNullOrEmpty() || emailET.text.toString().isNullOrEmpty() ||
            ...
            Toast.makeText(context, getString(R.string.error_profile_incomplete), Toast.LENGTH_SHORT)
                .show()
        } else {
            ...
            val gender =
                if (radioMan1.isChecked) {
                    GENDER_MALE
                } else {
                    GENDER_FEMALE
                }
            val preferredGender =
                if (radioMan2.isChecked) {
                    GENDER_MALE
                } else {
                    GENDER_FEMALE
                }
